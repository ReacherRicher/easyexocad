...
const testimonials = [
  {
    ...
    role: 'دانشجو',
    quote:
      'دوره مقدماتی را با سرعت خوبی پیش بردم. توضیحات واضح بود و توانستم طراحی کراون را یاد بگیرم.',
    rating: 5,
  },
  {
    name: 'زهرا کریمی',
    ...
    quote:
      'پشتیبانی بعد از خرید خوب بود و سوال‌هایم سریع جواب داده می‌شد. محتوای دوره پیشرفته کامل بود.',
    rating: 5,
  },
  {
    name: 'رضا صادقی',
    role: 'دانشجو',
    quote:
      'مدرس با تجربه است و مثال‌های کاربردی می‌زند. دوره را به همکارانم توصیه کردم.',
    rating: 5,
  },
]
